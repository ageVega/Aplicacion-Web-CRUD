...
file_paths = [
    ...
    os.path.join(script_dir, os.pardir, 'static', 'js', 'modules', 'priorityManager.js'),
    os.path.join(script_dir, os.pardir, 'static', 'js', 'modules', 'taskManager.js'),
    os.path.join(script_dir, os.pardir, 'static', 'js', 'modules', 'userManager.js'),
